...
1. Rode o runtime manager PRIMEIRO, com o comando real (funciona de qualquer pasta):
   `node /home/usuario/personal-agent/engine/runtime-manager.ts start`
...
2. Carregue o CORE (caminhos absolutos): `/home/usuario/personal-agent/core/persona.md`, `goal.md`, `rules.md`, `workflow.md`.
3. Carregue `/home/usuario/personal-agent/role/ROLE.md` (lente DEV/PO).
